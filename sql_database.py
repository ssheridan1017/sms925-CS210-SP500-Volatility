...
# EXAMPLE QUERIES
# Each query is a mirror to a real world query that would be used in market analysis.
...
# QUERY 2: MACRO INDIVATOR vs MARKET PERFORMANCE BY YEAR 
# For each year, how did the certain indicators (inflation, unemployment,
# interest rates) relate to average price levels and volatility?
# This will show us how or if the macroeconoic indicators relate to preformance
...
# Compare average price action and volatility when interest rates are above vs below the median.
print("\nHigh vs Low Interest Rate Environment")
...
# Then checks if those days are more volatile and more bearish?
...
# Group days into 4 categories based on inflation and unemployment
# being above or below their averages. Which combo produced the best returns?
print("\nS&P 500 Performance by Category")
